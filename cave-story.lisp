...
(defun transport-to-pole! ()
  ...
  (setq *env*
	(interpret-tsc-command *env* `((:key . :tra) (:ARGS . ,(alist :map-key :pole :event-num 92 :pos (tile-v 7 9)))))))
...
(defvar* *tsc-command-table*
    '(((:key . :AE+) (:command . "AE+") (:description . "Refill ammo"))
      ((:key . :AM+) (:command . "AM+") (:description . "Get weapon X, add Y to max ammo (just adds ammo if you have the weapon)"))
      ((:key . :AM-) (:command . "AM-") (:description . "Lose weapon X"))
      ((:key . :AMJ) (:command . "AMJ") (:description . "Jump to event Y if you have weapon X"))
      ((:key . :ANP) (:command . "ANP") (:description . "Animate entity X with method Y in direction Z [entity type determines Y values?]"))
      ((:key . :BOA) (:command . "BOA") (:description . "Animate boss entity. Give map-boss scriptstate X."))
      ((:key . :BSL) (:command . "BSL") (:description . "Start boss fight with entity W. Use 0000 to end the boss fight. (NPC flag 0200 must be set; should work with anything that has HP)"))
      ((:key . :CAT) (:command . "CAT") (:description . "Instantly display text. Use before a <MSG/2/3; works until <END. Same command as <SAT."))
      ((:key . :CIL) (:command . "CIL") (:description . "Credits: Clear the illustration."))
      ((:key . :CLO) (:command . "CLO") (:description . "Close the text box (used after MSG/MS2/MS3)"))
      ((:key . :CLR) (:command . "CLR") (:description . "Clear the text box (used after MSG/MS2/MS3)"))
      ((:key . :CMP) (:command . "CMP") (:description . "Change map coords X:Y to tile Z. Produces Smoke."))
      ((:key . :CMU) (:command . "CMU") (:description . "Change music to song X") (:arg-keys :song-num))
      ((:key . :CNP) (:command . "CNP") (:description . "Change all entities X to entity type Y with direction Z"))
      ((:key . :CPS) (:command . "CPS") (:description . "Stop propeller sound (used after SPS) (from helicopter cutscene after final battles)"))
      ((:key . :CRE) (:command . "CRE") (:description . "Roll credits"))
      ((:key . :CSS) (:command . "CSS") (:description . "Stop stream sound (used after SSS) (from River area)"))
      ((:key . :DNA) (:command . "DNA") (:description . "Remove all entities of type X."))
      ((:key . :DNP) (:command . "DNP") (:description . "Entity X is removed completely"))
      ((:key . :ECJ) (:command . "ECJ") (:description . "Jump to event Y if any entity with ID X is present"))
      ((:key . :END) (:command . "END") (:description . "End scripted event"))
      ((:key . :EQ+) (:command . "EQ+") (:description . "Add X to equip flag bytes"))
      ((:key . :EQ-) (:command . "EQ-") (:description . "Subtract X from equip flag bytes"))
      ((:key . :ESC) (:command . "ESC") (:description . "Quit to title screen"))
      ((:key . :EVE) (:command . "EVE") (:description . "Jump to event X (non-conditional)"))
      ((:key . :FAC) (:command . "FAC") (:description . "Show face X in text box"))
      ((:key . :FAI) (:command . "FAI") (:description . "Fade in with direction X") (:arg-keys :dir-num))
      ((:key . :FAO) (:command . "FAO") (:description . "Fade out with direction X"))
      ((:key . :FL+) (:command . "FL+") (:description . "Set flag X"))
      ((:key . :FL-) (:command . "FL-") (:description . "Clear flag X"))
      ((:key . :FLA) (:command . "FLA") (:description . "Flash the screen white"))
      ((:key . :FLJ) (:command . "FLJ") (:description . "Jump to event Y if flag X is set"))
      ((:key . :FMU) (:command . "FMU") (:description . "Fade the music to a low volume (good to use before CMU)"))
      ((:key . :FOB) (:command . "FOB") (:description . "Focus on boss X in Y ticks. Use Y > 0."))
      ((:key . :FOM) (:command . "FOM") (:description . "Focus view on you (normal view), view movement takes X ticks (WARNING: speed 0000 crashes)"))
      ((:key . :FON) (:command . "FON") (:description . "Focus view on entity X, view movement takes Y ticks"))
      ((:key . :FRE) (:command . "FRE") (:description . "Frees menu cursor [also used after ZAM for some reason?]"))
      ((:key . :GIT) (:command . "GIT") (:description . "Show weapon/item X icon above text box - add 1000 to X for items - GIT0000 to hide"))
      ((:key . :HMC) (:command . "HMC") (:description . "Removes main character entity (use SMC after)"))
      ((:key . :INI) (:command . "INI") (:description . "Resets memory and starts game from the beginning"))
      ((:key . :INP) (:command . "INP") (:description . "Change entity X to type Y with direction Z and set entity flag 100 (0x8000)."))
      ((:key . :IT+) (:command . "IT+") (:description . "Get item X"))
      ((:key . :IT-) (:command . "IT-") (:description . "Lose item X"))
      ((:key . :ITJ) (:command . "ITJ") (:description . "Jump to event Y if you have item X"))
      ((:key . :KEY) (:command . "KEY") (:description . "Hides status bars and locks out input to your character until END (used with MSG/MS2/MS3 and PRI)"))
      ((:key . :LDP) (:command . "LDP") (:description . "Loads profile.dat into memory and starts game from save"))
      ((:key . :LI+) (:command . "LI+") (:description . "Restore X amount of health"))
      ((:key . :ML+) (:command . "ML+") (:description . "Max health increased X amount"))
      ((:key . :MLP) (:command . "MLP") (:description . "Display map [how is this used without blanking screen while map is displayed?]"))
      ((:key . :MM0) (:command . "MM0") (:description . "Instantly halts your horizontal motion"))
      ((:key . :MNA) (:command . "MNA") (:description . "Displays name of current map"))
      ((:key . :MNP) (:command . "MNP") (:description . "Move entity X to coords Y:Z facing direction W"))
      ((:key . :MOV) (:command . "MOV") (:description . "Move you to coords X:Y"))
      ((:key . :MP+) (:command . "MP+") (:description . "Set a map flag."))
      ((:key . :MPJ) (:command . "MPJ") (:description . "Jump to event X if map flag is set for the current area."))
      ((:key . :MS2) (:command . "MS2") (:description . "Open invisible text box at top of screen (text follows)"))
      ((:key . :MS3) (:command . "MS3") (:description . "Open normal text box at top of screen (text follows)"))
      ((:key . :MSG) (:command . "MSG") (:description . "Open normal text box (text follows)"))
      ((:key . :MYB) (:command . "MYB") (:description . "Knocks you back from direction X (0000 knocked right, 0002 knocked left, any other just hops in place)"))
      ((:key . :MYD) (:command . "MYD") (:description . "Make you face direction X"))
      ((:key . :NCJ) (:command . "NCJ") (:description . "Jump to event Y if any entity of type X is present"))
      ((:key . :NOD) (:command . "NOD") (:description . "Text box wait for button press (used after MSG/MS2/MS3)"))
      ((:key . :NUM) (:command . "NUM") (:description . "Prints the value [4a5b34+W*4] to the message box. Use 0000 to print the last used X from compatible commands (eg AM+)."))
      ((:key . :PRI) (:command . "PRI") (:description . "Hides status bars and freezes game action until KEY or END (used with MSG/MS2/MS3)"))
      ((:key . :PS+) (:command . "PS+") (:description . "Set teleporter slot X to location Y"))
      ((:key . :QUA) (:command . "QUA") (:description . "Shake the screen for X ticks"))
      ((:key . :RMU) (:command . "RMU") (:description . "Restore music playback"))
      ((:key . :SAT) (:command . "SAT") (:description . "Instant text display on all messages until END (glitches scrolling text)"))
      ((:key . :SIL) (:command . "SIL") (:description . "Show illustration during credits (use CIL after)"))
      ((:key . :SK+) (:command . "SK+") (:description . "Set skipflag X (remains set until program exits, to avoid repeating cutscenes/dialogue after retrying)"))
      ((:key . :SK-) (:command . "SK-") (:description . "Clear skipflag X"))
      ((:key . :SKJ) (:command . "SKJ") (:description . "Jump to event Y if skipflag X is set"))
      ((:key . :SLP) (:command . "SLP") (:description . "Teleporter location menu"))
      ((:key . :SMC) (:command . "SMC") (:description . "Restores main character entity (used after HMC)"))
      ((:key . :SMP) (:command . "SMP") (:description . "Jump to event X if skipflag W is set. Does not create smoke."))
      ((:key . :SNP) (:command . "SNP") (:description . "Create an entity of type X at coordinates Y:Z with direction W."))
      ((:key . :SOU) (:command . "SOU") (:description . "Play sound effect X"))
      ((:key . :SPS) (:command . "SPS") (:description . "Start propeller sound (use CPS after) (from helicopter cutscene after final battles)"))
      ((:key . :SSS) (:command . "SSS") (:description . "Start stream sound at pitch X (use CSS after) (from River area - normal pitch is 0400)"))
      ((:key . :STC) (:command . "STC") (:description . "Saves the current time to 290.rec"))
      ((:key . :SVP) (:command . "SVP") (:description . "Save game"))
      ((:key . :TAM) (:command . "TAM") (:description . "Trade weapon X for weapon Y, set max ammo to Z (max ammo 0000 = no change) (GLITCH: first weapon 0000)"))
      ((:key . :TRA) (:command . "TRA") (:description . "Load map X, run event Y, transport you to coords Z:W") (:arg-keys :map-num :event-num :tile-x :tile-y))
      ((:key . :TUR) (:command . "TUR") (:description . "Instantly display text. Use after a <MSG/2/3; works until another <MSG/2/3 or an <END."))
      ((:key . :UNI) (:command . "UNI") (:description . "0000 normal / 0001 zero-g movement, facing direction is locked (disables focus commands) (from Stream boss) / 0002 movement is locked, can still fire"))
      ((:key . :WAI) (:command . "WAI") (:description . "Pause script for X ticks"))
      ((:key . :WAS) (:command . "WAS") (:description . "Pause script until your character touches the ground"))
      ((:key . :XX1) (:command . "XX1") (:description . "Show the island falling in manner W. Use 0000 to have it crash and 0001 to have it stop midway."))
      ((:key . :YNJ) (:command . "YNJ") (:description . "Ask yes or no, jump to event X if No"))
      ((:key . :ZAM) (:command . "ZAM") (:description . "All weapons drop to level 1")))
